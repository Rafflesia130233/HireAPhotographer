class JobDetail < ApplicationRecord
  belongs_to :user, autosave:true, foreign_key: 'user_id'
  has_many :applications, foreign_key: 'job_detail_id'
  has_many :hire_details, foreign_key: 'hire_detail_id'
 ...
 def self.options_for_sorted_by
  ...
  def decorated_validTill
    validTill.to_date.to_s(:long)
  end
end
