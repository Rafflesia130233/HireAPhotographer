class CertificationsController < ApplicationController
  ...
  def create
    ...
    if has_profile?
        @certification.profile = current_user.profile
    end
  ...
  def redirect_cancel
    ...
    def certification_params
      params.fetch(:certification, {})
      params.require(:certification).permit(:name,:startDate,:endDate,:validTill,:organization, :description, :result,:remark,:profile_id)
    end
end
